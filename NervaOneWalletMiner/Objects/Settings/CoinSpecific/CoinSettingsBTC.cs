...
namespace NervaOneWalletMiner.Objects.Settings.CoinSpecific
{
    internal class CoinSettingsBTC : ICoinSettings
    {
        ...
        private string _CliUrlWindows64 = "https://bitcoincore.org/bin/bitcoin-core-31.0/bitcoin-31.0-win64.zip";
        private string _CliUrlWindows32 = "https://bitcoincore.org/bin/bitcoin-core-31.0/bitcoin-31.0-win64.zip";
        private string _CliUrlLinux64 = "https://bitcoincore.org/bin/bitcoin-core-31.0/bitcoin-31.0-x86_64-linux-gnu.tar.gz";
        private string _CliUrlLinux32 = "https://bitcoincore.org/bin/bitcoin-core-31.0/bitcoin-31.0-x86_64-linux-gnu.tar.gz";
        private string _CliUrlLinuxArm = "https://bitcoincore.org/bin/bitcoin-core-31.0/bitcoin-31.0-arm-linux-gnueabihf.tar.gz";
        private string _CliUrlMacIntel = "https://bitcoincore.org/bin/bitcoin-core-31.0/bitcoin-31.0-x86_64-apple-darwin.tar.gz";
        private string _CliUrlMacArm = "https://bitcoincore.org/bin/bitcoin-core-31.0/bitcoin-31.0-arm64-apple-darwin.tar.gz";
        ...
        private string _DataDirWindows = Path.Combine(GlobalMethods.GetDataDir(), "Bitcoin");
        private string _DataDirLinux = Path.Combine(GlobalMethods.GetDataDir(), "Bitcoin");
        private string _DataDirMac = Path.Combine(GlobalMethods.GetDataDir(), "Bitcoin");
